...
// TODO: [20221215-코드리뷰-1번-확인] testDB라는 명칭으로 설정했던 DB 이름을 ParkAebinDB로 변경 (MySQL에서도 새로 생성하시기 바랍니다.) - done
// -> 변경이 안되어있어서 리뷰 진행중 변경

// TODO: [20221215-코드리뷰-2번-확인] ParkAebinDB의 사용자를 새로 생성하여 연결하도록 수정 (root 계정을 사용하는게 아닌 새로운 사용자로 연결을 시도해야합니다.) -> database 폴더에 SQL파일 생성해주세요. - done
